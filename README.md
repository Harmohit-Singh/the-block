...
- **Step 4**: Open the localpost url in your browser (Google Chrome preferred). `http://localhost:5173/` is the default
...
![Mobile inventory browse](screenshots/mobile_browse.png)

**Vehicle detail**

![Mobile vehicle detail](screenshots/mobile_details.png)
